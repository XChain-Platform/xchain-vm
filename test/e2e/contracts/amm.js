...
// AMM constant-product swap contract
module.exports = {
    ...
    addLiquidity: function(xchain) {
        ...
        xchain.log('liquidity added:', amountA, amountB);
    },
    swap: function(xchain) {
        ...
        xchain.require(
            xchain.math.gt(reserveA, '0') && xchain.math.gt(reserveB, '0'),
            'no liquidity'
        );
        ...
        xchain.log('swapped', inputAmount, inputToken, 'for', outputAmount, outputToken);
        return outputAmount;
    }
};

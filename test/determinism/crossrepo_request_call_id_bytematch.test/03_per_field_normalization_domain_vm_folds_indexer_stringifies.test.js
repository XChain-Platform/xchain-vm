...
// so it reddens when the INDEXER's coercion moves. Local lambda restatements can
// only measure themselves and leave indexer-side edits invisible.

const TXH = 'abc123', POS = 0;
const COIN_CONFIG = { NETWORK: 'regtest', COIN: 'BTC' };
let IDX = null;

function loadIndexerBefore() {

 ...
 *
 *   node test/determinism/helpers/generate_golden.js            # write golden-manifest.json
 *   node test/determinism/helpers/generate_golden.js --platform # write per-platform snapshot only
 *
...
main().then(() => process.exit(0)).catch(e => {
    process.stderr.write('generate_golden failed: ' + (e && e.stack || e) + '\n');
    process.exit(1);
});

...
const { createVM, execute, hashResult, XChainVM } = require('../fuzz/helpers/harness.js');

const CODE = fs.readFileSync(path.join(__dirname, '../fixtures/contracts/catch_recursion.js'), 'utf8');

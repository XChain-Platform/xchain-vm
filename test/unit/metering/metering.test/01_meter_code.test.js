...
function registerLoopMeteringTests() {
...
function registerBranchMeteringTests() {
...
function registerFunctionMeteringTests() {
...
function registerEntryPointMeteringTests() {
...
function registerCallAndOutputTests() {
...
function registerModernSyntaxMeteringTests() {
...
describe('Metering', function() {
    ...
    registerLoopMeteringTests();
    registerBranchMeteringTests();
    registerFunctionMeteringTests();
    registerEntryPointMeteringTests();
    registerCallAndOutputTests();
    registerModernSyntaxMeteringTests();
    });

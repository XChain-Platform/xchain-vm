...
const { XChainVM, createVM, execute, ProgrammableMock, chaosAssertions } = require('../helpers/harness.js');
const { ProgrammableOracleProvider, ProgrammableCrossChainProvider } = require('../helpers/programmable-mock.js');
const { checkResultShape, checkAtomicity } = require('../../fuzz/helpers/invariants.js');

const gatewayCallerCode = fs.readFileSync(
    path.join(__dirname, '../fixtures/contracts/gateway_caller.js'), 'utf8'
);

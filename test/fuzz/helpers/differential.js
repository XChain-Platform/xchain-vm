 ...
 *      then `diffManifests()` every pair (see differential_run.js +
...
const {
    ...
    adversarialCodeArb,
    VALID_TEMPLATES
} = require('./generators/code.js');
const { mixedParamsArb } = require('./generators/args.js');
const { initialStateArb } = require('./generators/state.js');

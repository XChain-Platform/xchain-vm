 ...
 *
 * Usage:
 *   node test/fuzz/helpers/run.js              # all categories
 *   node test/fuzz/helpers/run.js code         # only code.fuzz.test.js
 *   node test/fuzz/helpers/run.js math state   # multiple categories
 *
 * Environment:

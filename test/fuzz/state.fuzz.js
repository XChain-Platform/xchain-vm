...
const { XChainVM, createVM, execute, FC_OPTIONS, DEFAULT_LIMITS } = require('./helpers/harness.js');
const { checkResultShape, checkAtomicity, checkStateLimits, checkNoPrototypePollution, checkAll } = require('./helpers/invariants.js');
const {

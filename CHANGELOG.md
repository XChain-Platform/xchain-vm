...
### Added
- The bugfix regression tier carries four bug tests: null emit params, byte-counted log truncation, return-value serialization and tier integrity.
...
### Fixed
- Simulator block height and limits derive from their authorities instead of hardcoded literals.
- A contract is told when an oracle round has scrolled out of the preload window.
